...
import { EarthIcon, GraduationCapIcon } from "lucide-react";
        ...
        <div className="bg-background dark:bg-background px-8 py-8 md:py-12 lg:py-24 border-y-2 border-dashed">
          <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
            ...
            <p className="pt-10 text-center leading-normal">
              The need of human-machine interface (HMI) motivates us to develop
              an app that can monitor and control our devices in real-time
              manner. In order to achieve that, the app must be modular,
              scalable, modern, dynamic and responsive, which bring us here, the{" "}
              <br />
              ...
              <div className="flex flex-col justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Full-stack React framework. Development using App Directory,
                    Routing, Layouts, and API.
                  </p>
                </div>
              </div>
            </div>
            <div className="rounded-lg border p-2 bg-accent dark:bg-accent">
              <div className="flex flex-col justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Latest React with Server and Client Components. Fetching
                    data using TanStack Query and tRPC.
                  </p>
                </div>
              </div>
            </div>
            <div className="rounded-lg border p-2 bg-accent dark:bg-accent">
              <div className="flex flex-col justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    PostgreSQL and MongoDB databases. Object relational mapping
                    using Prisma schema coupled with Zod validation.
                  </p>
                </div>
              </div>
            </div>
            <div className="rounded-lg border p-2 bg-accent dark:bg-accent">
              <div className="flex flex-col justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Customizable and accessible UI components. Design using
                    ShadcnUI and styled with TailwindCSS.
                  </p>
                </div>
              </div>
            </div>
            <div className="rounded-lg border p-2 bg-accent dark:bg-accent">
              <div className="flex flex-col justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Secure and flexible. Authentication using NextAuth.js with
                    GitLab and Slack as passwordless Oauth providers.
                  </p>
                </div>
              </div>
            </div>
            <div className="rounded-lg border p-2 bg-accent dark:bg-accent">
              <div className="flex flex-col justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Snappy and reliable. Standardized real-time communication
        ...
        <div className="bg-background dark:bg-background px-8 py-8 md:py-12 lg:py-24">
          <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
            ...
            <div className="pt-10 text-justify leading-normal space-y-3">
              <p>
                The Robotics & Autonomous Systems lab is a research unit of the
                department of Mechanics of the Belgian Royal Military Academy.
              </p>
              <p>
                As a university laboratory, we conduct research in all matters
                related to unmanned systems: on one hand trying to develop novel
                &quot;good&quot; applications for these systems and on the other
                hand trying to find solutions to counter the potential malicious
                use of these systems.
              </p>
              <p>
                As a military research institute and part of Belgian Defence, we
                focus on niche fundamental research axes and apply those to
                practical applications that provide a direct added value for our
                end users, mostly in the safety, security and defence sectors.
              </p>
            </div>
          </div>
          <div className="pt-10 mx-auto grid md:justify-center gap-y-6 gap-x-3 md:max-w-5xl md:grid-cols-3 sm:grid-cols-1">
            ...
            <div className="leading-normal md:pl-[60px]">
              ...
              <div className="space-y-2">
                <p>
                  Telephone:{" "}
                  <Link href={"tel:" + siteConfig.contacts.telephone}>
