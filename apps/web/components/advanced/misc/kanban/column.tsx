...
export function KanbanColumn({ id, title, items, onWorkspaceDeleted, categoryId, onEdit, onDelete }: KanbanColumnProps) {
    const {
        setNodeRef,
        attributes,
        listeners,
    ...
    return (
        <div ref={setNodeRef} style={style} className="flex h-full w-[350px] min-w-[350px] flex-col rounded-lg border bg-muted/50">
            <div
                {...attributes}
                {...listeners}
                ...
                {categoryId && categoryId !== -1 && (
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            <DropdownMenuItem onClick={() => onEdit?.({ id: categoryId, name: title })}>
