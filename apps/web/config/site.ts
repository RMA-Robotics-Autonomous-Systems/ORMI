...
export const siteConfig: SiteConfig = {
	name: "ORMI",
	description:
		"Open Robotic Management Interface. A central platform that supports heterogenous and scalable robotics and autonomous systems.",
	...
	address:
		"Robotics & Autonomous Systems Department of Mechanics, Royal Military Academy, Avenue De La Renaissance 30, 1000 Brussels, Belgium",
	contacts: {
	...
	links: {
		...
		googlescholar:
			"https://scholar.google.be/citations?user=WOdds4wAAAAJ&hl=nl&authuser=1",
