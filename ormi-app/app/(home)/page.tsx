    ...
    <>
      ...
      <section className="space-y-6 dark:bg-transparent px-8 py-8 md:py-12 lg:py-24">
        <div className="flex flex-col items-center gap-4 text-center">
         ...
         <Image
        src="/logo/ras-app-logo-light.svg"
        width={500}
        height={500}
        priority
        ...
        /> 
        <Image
        src="/logo/ras-app-logo-dark.svg"
        width={500}
        height={500}
        priority
        alt="RAS-APP Logo Dark"
        className="hidden dark:block"
        /> 
      
          <p className="max-w-5xl leading-normal sm:text-xl sm:leading-8">
          A central platform that supports heterogenous and scalable robotics and autonomous systems for the RMA-MECA-RAS usage.
          </p>
      ...
      <div className="bg-background dark:bg-background px-8 py-8 md:py-12 lg:py-24 border-y-2 border-dashed">
        <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
          ...
          <p className="pt-10 text-center leading-normal">
            ...
            <br/>
            <a className="underline font-bold" >RAS-APP</a>
            .
          </p>
        </div>
