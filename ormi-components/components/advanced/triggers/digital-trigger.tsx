...
export const DigitalComponent = (props: DigitalInputComponentProps) => {
    ...
    useEffect(() => {
        const keyPressEvent = (event: KeyboardEvent) => {
            ...
            if (data?.type === 'keyboard' && event.key.toLowerCase() === data.key?.toLowerCase()) {
        ...
        const gamePadInterval = setInterval(() => {
            ...
            if (data?.type !== 'gamepad' || data.gamepadButtonIndex === undefined) return;
    ...
    }, [data, props.onActive, props.onInactive]);
    ...
    return (
        <div style={{ width: '10rem' }}>
            ...
            <span data-active={isActive} className={styles.key} onMouseDown={handMouseDown} onMouseUp={handMouseUp}>
                <div
                    style={{
                        display: 'flex',
                        alignItems: 'center',
                ...
                >
                    ...
                    {data?.type === 'keyboard' ? (
                        ...
                        <>
                            ...
                            {data.gamepadButtonIndex !== undefined ? getGamepadButtonName(data.gamepadButtonIndex, data.gamepadId) : 'N/A'}
                        </>
                    ) : (
