    ...
    return (
        <div style={{ height: "100%", overflow: "auto", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            >
                ...
                <h2 style={{ color: "#111827", marginBottom: "0.75rem", fontWeight: "500", textAlign: "center" }}>Widget Not Found</h2>
                <p style={{ color: "#6b7280", fontSize: "0.875rem", textAlign: "center", lineHeight: "1.5" }}>
                    The requested widget could not be found. This may be due to a missing plugin or an incorrect widget ID.
                </p>
                <div style={{
                    width: "100%",
                    height: "1px",
