...
function ConditionStatusIndicator(props) {
    ...
    var status = props.status.find(function (status) {
    ...
    return (_jsx("div", { style: {
        ...
        }, children: _jsx(TypeAnimation, { speed: 75, cursor: false, sequence: [status.name], repeat: 1 }, status.name) }));
}
export function CondStatusIndicatorDefinition() {
    ...
    return {
        ...
        Component: function (data) { return (_jsx(LocalDataSourcesProvider, { SelectedTopics: [data.topic], buffersSize: 1, children: _jsx(ConditionStatusIndicator, __assign({}, data)) })); }
    };
}
;
