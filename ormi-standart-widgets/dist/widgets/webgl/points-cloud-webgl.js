    ...
    return {
        ...
        uischema: {
            ...
            elements: [
                    ...
                    type: "TopicSelect", scope: "#/properties/topic", options: {
                        asyncFunction: function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, pluginsManager.applyFilterAsync(PluginsHooks.AVAILABLE_TOPICS, [], new DatasourceTopicFilter({ type: /PointsCloud/ }))];
                ...
                { type: "Control", scope: "#/properties/maxPoints" }
            ]
        },
        data: {
            title: 'Status',
        ...
        Component: function (data) { return (_jsx(LocalDataSourcesProvider, { SelectedTopics: [data.topic], buffersSize: 1, children: _jsx(PointsCloudCompWebGL, __assign({}, data)) })); }
    };
}
