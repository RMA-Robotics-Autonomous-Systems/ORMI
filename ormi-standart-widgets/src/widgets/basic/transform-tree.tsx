...
function TransformTreeViewer(props: TransformTreeViewerProps): JSX.Element {
    ...
    useEffect(() => {
        ...
        if (!transformsTrees || transformsTrees.size === 0 || !divRef.current) return;
    ...
    }, [transformsTrees, props.treeId, props.showCoordinates, resolvedTheme, divRef.current]);
    ...
    return {
        ...
        uischema: {
            ...
            elements: [
                ...
                { type: "Control", scope: "#/properties/showCoordinates" } as ControlElement,
                { type: "Control", scope: "#/properties/treeId" } as ControlElement,
            ]
        } as VerticalLayout,
        data: {
