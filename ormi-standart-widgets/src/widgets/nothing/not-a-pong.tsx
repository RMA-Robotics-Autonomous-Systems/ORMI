    ...
    useEffect(() => {
        ...
        const update = (delta: number) => {
            ...
            if (!props.aiVsAi) {
                ...
                if (ballSpeedX < 0) {
                    ...
                    while (remainingTime > 0) {
                        if (vy > 0) {
                            const timeToBottom = (ch - ballRadius - predictedY) / vy;
                            ...
                            const timeToTop = (predictedY - ballRadius) / Math.abs(vy);
                ...
                if (targetPlayerPaddleY > ch - paddleHeight) targetPlayerPaddleY = ch - paddleHeight;
            ...
            if (ballX - ballRadius < 0) {
                ...
                paused = true;
                updateElements();
                setTimeout(() => { resetBall(); paused = false; }, 500);
                return;
            ...
            if (targetAIPaddleY > ch - paddleHeight) targetAIPaddleY = ch - paddleHeight;
    ...
    return (
        ...
        >
            ...
            <div
                ...
                }}            ></div>            {/* Ball */}            <div ref={ballRef} style={{
