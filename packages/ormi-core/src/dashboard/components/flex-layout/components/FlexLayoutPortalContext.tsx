...
interface FlexLayoutPortalContextType {
    ...
    openDialog: (widgetId: string, widget: any, definition: any, onUpdateWidget: (box_id: string, settings: any) => void) => void;
    closeDialog: () => void;
    dialogState: DialogState | null;
}

const FlexLayoutPortalContext = createContext<FlexLayoutPortalContextType | null>(null);
 ...
 */
export const FlexLayoutPortalProvider: React.FC<FlexLayoutPortalProviderProps> = ({ children }) => {
    ...
    const openDialog = useCallback((widgetId: string, widget: any, definition: any, onUpdateWidget: (box_id: string, settings: any) => void) => {
        setDialogState({
            isOpen: true,
            widgetId,
            widget,
...
export const useFlexLayoutPortal = (): FlexLayoutPortalContextType => {
    ...
    if (!context) {
        throw new Error('useFlexLayoutPortal must be used within a FlexLayoutPortalProvider');
    }
    return context;
};