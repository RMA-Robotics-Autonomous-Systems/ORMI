...
const DatasourceCard = (props: DatasourceCardProps) => {
  ...
  const renderers = [...materialRenderers, ...shadcnRenderer, ...coreRenderer];
    ...
    <Dialog>
      <DialogTrigger asChild>
        <Button
          variant={"ghost"}
          className={
            props.data?.title === "New Datasource" ? "animate-pulse" : ""
          }
          style={
      ...
      <DialogContent size="large">
        <DialogHeader>
          ...
          <DialogDescription>Datasource configuration</DialogDescription>
        </DialogHeader>
        <div>
          <JsonForms
