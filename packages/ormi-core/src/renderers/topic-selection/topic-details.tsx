          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {topic.type && (
                  <Badge variant="secondary">Webapp: {topic.type}</Badge>
                )}
                {topic.rawType && (
                  <Badge variant="outline">Raw: {topic.rawType}</Badge>
                )}
              </div>
            </div>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  {analysis.compatibleProperties.length > 0 &&
                    !analysis.directMatch && (
                      <p className="text-xs text-green-600">
                        {analysis.compatibleProperties.length} compatible
                        properties found
                      </p>
                    )}

                  {analysis.reason && (
                    <p className="text-xs text-red-600">{analysis.reason}</p>
                  )}
                </div>
              </div>
            )}
          ...
          <CardContent className="pt-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                value={bufferSize}
                onChange={(e) =>
                  onBufferSizeChange(parseInt(e.target.value) || 1)
                }
                className="w-full"
              />
