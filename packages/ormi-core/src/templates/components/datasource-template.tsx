...
import { PlusIcon, SettingsIcon, TrashIcon, CheckIcon, XIcon } from "lucide-react";
...
export const DatasourceTemplateComponent = (props: DatasourceTemplateProps) => {
    ...
    const [editedTemplate, setEditedTemplate] = useState<DatasourceTemplate>({ ...template });
        ...
        <div key={templateId} className="flex items-center justify-between p-2 border-b border-gray-200">
            ...
            <div className="flex gap-2">
                {template.yours && (
                    <Dialog open={optionsOpen} onOpenChange={setOptionsOpen}>
                        ...
                        <DialogContent className="max-w-md">
                            <DialogHeader>
                                <DialogTitle>Edit Datasource Template</DialogTitle>
                            </DialogHeader>
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center space-x-2">
                                    <Switch
                                        ...
                                        onCheckedChange={(checked) => setEditedTemplate(prev => ({ ...prev, public: checked }))}
                                    />
                ...
                <Button variant="outline" onClick={() => {
                    ...
                    const definition = availableDatasources.find(d => d.id === template.datasource.datasource_id);
                    if (!definition) {
