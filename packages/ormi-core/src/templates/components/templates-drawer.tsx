...
export function WidgetTemplateDrawer(props: WidgetTemplateDrawerProps) {
  ...
  const yourDatasourceTemplates = filteredTemplates
    .filter(
      ([key, template]) => template.type === "datasource" && template.yours,
    )
    .reduce((acc, [key, template]) => {
                ...
                <AccordionItem value="public-widgets">
                  ...
                  <AccordionContent>
                    {publicWidgetTemplates.size === 0 ? (
                      ...
                      Array.from(publicWidgetTemplates.entries()).map(
                        ([key, template]) => (
                          <TemplateComponent
                            key={key}
                            templateId={key}
                ...
                <AccordionItem value="user-datasources">
                  ...
                  <AccordionContent>
                    {yourDatasourceTemplates.size === 0 ? (
                      ...
                      Array.from(yourDatasourceTemplates.entries()).map(
                        ([key, template]) => (
                ...
                <AccordionItem value="public-datasources">
                  ...
                  <AccordionContent>
                    {publicDatasourceTemplates.size === 0 ? (
                      ...
                      Array.from(publicDatasourceTemplates.entries()).map(
                        ([key, template]) => (
                          <DatasourceTemplateComponent
                            key={key}
                            templateId={key}
