...
interface TopicSelectElement
  extends Omit<import("@jsonforms/core").ControlElement, "type"> {
  type: "TopicSelect";
  options?: {
...
export type { WidgetDefinition, Widget, DataRequirements, TopicSelectElement };
