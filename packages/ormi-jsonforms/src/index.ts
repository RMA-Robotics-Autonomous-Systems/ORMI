...
} from "./layouts/ShadcnCategorizationStepperLayout";
...
import ShadcnColorCell, {
  shadcnColorCellTester,
} from "./controls/cells/ShadcnColorCell";
import ShadcnColorControl, {
  shadcnColorControlTester,
} from "./controls/simples/ShadcnColorControl";
import axisSelectorControl, { axisSelectorTester } from "./controls/key/axis";
import {
  ShadcnOneOfLayoutRenderer,
  shadcnOneOfTester,
...
export const shadcnRenderer: JsonFormsRendererRegistryEntry[] = [
  ...
  { tester: axisSelectorTester, renderer: axisSelectorControl },
  {
    ...
    renderer: ShadcnVerticalLayoutRenderer,
  },
  {
    tester: shadcnHorizontalLayoutTester,
    renderer: ShadcnHorizontalLayoutRenderer,
  },
...
export type { KeyControlType } from "./controls/key/key";
export type { axisControlType } from "./controls/key/axis";
