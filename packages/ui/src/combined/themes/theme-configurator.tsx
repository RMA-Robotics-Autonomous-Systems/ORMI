            ...
            {predefinedThemes.map((theme) => {
              ...
              return (
                <Button
                  key={theme.name}
                  variant={
                    currentConfig.name === theme.name ? "default" : "outline"
                  }
                  size="sm"
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden">
        <DialogHeader>
          ...
          <DialogDescription>
            Customize your theme colors and save/load configurations. Changes
            are applied live to see the effects immediately.
          </DialogDescription>
        </DialogHeader>
