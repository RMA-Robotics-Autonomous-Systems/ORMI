...
function get_plugins(): string[] {
    ...
    console.log(chalk.cyan(`🔍 Scanning ${nodeModulesPaths.length} node_modules directories for ORMI plugins...`));
    ...
    for (const nodeModulesPath of nodeModulesPaths) {
        ...
        console.log(chalk.yellow(`📦 Found ${totalDirs} potential packages to check in this directory`));
