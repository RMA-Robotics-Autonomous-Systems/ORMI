...
export const LocalStorageProviderContext = createContext<LocalStorageProviderContextInterface | undefined>(undefined);

export const LocalStorageProvider = (props: LocalStorageProviderProps) => {
    return (
        <LocalStorageProviderContext.Provider value={{
            get: (key: string) => {
