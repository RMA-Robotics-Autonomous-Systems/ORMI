...
export const WebSocketProvider: React.FC<WebSocketProviderProps> = ({
    ...
    const handleError = useCallback((errorData: WebSocketError) => {
    ...
    const connect = useCallback(() => {
        ...
        setStatus(isReconnection ? WebSocketStatus.RECONNECTING : WebSocketStatus.CONNECTING);
        ...
        try {
            ...
            socket.onerror = (event) => {
                ...
                console.warn('WebSocket error occurred, will handle in onclose:', event);
            };
    ...
    }, [url, protocols, timeout, reconnectAttempts, reconnectInterval, onMessage, onError, onOpen, onClose, closeSocket, scheduleReconnection]);
...
const WebSocketStatusOverlay: React.FC<WebSocketStatusOverlayProps> = ({
    ...
    if (status === WebSocketStatus.CONNECTED || status === WebSocketStatus.DISCONNECTED) {
        return null;
    }
...
export const useWebSocketMessages = <T = any>() => {
    ...
    const sendTypedMessage = useCallback((message: T) => {
