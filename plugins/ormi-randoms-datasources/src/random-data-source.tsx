...
import { IMU, Movement, PointsCloud, Vector3 } from '@workspace/ormi-core/types';
                    ...
                    case 'PointsCloud':
                        ...
                        return setInterval(() => {
                            ...
                            for (let i = 0; i < numPoints; i++) {
                                ...
                                const pointObj = pointsObjects[i]!;

                                pointObj.x = basePoint.x + Math.sin(t + phase.x) * amplitude;
                                pointObj.y = basePoint.y + Math.sin(t + phase.y) * amplitude;
                                pointObj.z = basePoint.z + Math.sin(t + phase.z) * amplitude;
                            }
                            pluginsManager.doAction(
                                `${datasource_id}-${topic.topic}-published`,
                                {
