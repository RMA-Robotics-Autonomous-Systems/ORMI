...
const BagList = (props: BagListProps) => {
  ...
  return (
    ...
    >
      ...
      {error && (
        <Alert
          variant={error.includes("Downloading") ? "default" : "destructive"}
        >
            ...
            <CardContent>
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between gap-2 sm:gap-2">
                <div className="text-xs sm:text-sm min-w-0 flex-1">
                  <div className="flex flex-col gap-1">
                    <div className="truncate">
                      ...
                      <span className="break-all">{bag.path}</span>
                    </div>
                    <div>
                      <span className="font-medium text-gray-600">Start:</span>{" "}
                      <span className="break-all">
                        {formatDateTime(bag.meta.starting_time)}
                      </span>
                    </div>
                  </div>
                </div>
                <div className="flex flex-wrap gap-1 sm:gap-2 justify-start sm:justify-end">
                  ...
                  <Badge variant="outline" className="text-xs">
                    {bag.meta.topics_with_message_count.length} topics
                  </Badge>
                </div>
              </div>
            </CardContent>
        ...
        { type: "Control", scope: "#/properties/title" } as ControlElement,
        {
          ...
          options: {
            ...
            asyncFunction: async () => {
              ...
              ).filter((ds) => ds.datasource_id === "rest-bag-source");
