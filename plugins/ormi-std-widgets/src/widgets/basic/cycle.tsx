	...
	return {
		...
		schema: {
			...
			properties: {
				...
				loopCycle: {
					// If set to true, we loop through the values, if set to false, we switch direction
					type: "boolean",
					title: "Loop Cycle",
					default: true,
				},
				publishOnLoop: {
					//If set to false, we publish 1 value, if set to true, we keep publishing the value
					type: "boolean",
					title: "Loop publish",
					default: false,
				},
