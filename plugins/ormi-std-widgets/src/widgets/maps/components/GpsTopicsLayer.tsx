    ...
    <LocalDataSourcesProvider SelectedTopics={allTopics} buffersSize={50}>
      {topics.map((t) => {
        if (t.makerType === "simple") {
          return (
            <TopicMarker key={t.name} topic={t.topic} name={t.name} scale={1} />
          );
          ...
          return (
            <PathMarker key={t.name} topic={t.topic} name={t.name} scale={1} />
          );
        } else if (t.makerType === "multipoints") {
          return (
            <MultiPoints key={t.name} topic={t.topic} name={t.name} scale={1} />
          );
        }
