 ...
 */
export function MapToolbar({ mapRef, showGrid, onToggleGrid, onRefresh }: MapToolbarProps) {
    ...
    useEffect(() => {
        ...
        setButtonItem(
            ...
            <Button variant={showGrid ? "default" : "ghost"} onClick={onToggleGrid}>
    ...
    }, [mapRef, showGrid, onToggleGrid, onRefresh, setButtonItem, removeButtonItem]);
