                ...
                >
                    <div className="rounded-lg shadow-md p-3 bg-white text-gray-800">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-xs">{hoveredPoint.latitude.toFixed(6)}</span>
                        </div>
                        <div className="flex items-center space-x-2">
                            <span className="text-xs font-medium">Longitude:</span>
                            <span className="text-xs">{hoveredPoint.longitude.toFixed(6)}</span>
                        </div>
                        <div className="flex items-center space-x-2">
                            <span className="text-xs font-medium">Point:</span>
                            <span className="text-xs">{hoveredPoint.index + 1}/{locations.length}</span>
                        </div>
                    </div>
                </Popup>
            )}
