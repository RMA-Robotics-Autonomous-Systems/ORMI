...
export function TelloCommandsControl(props: TelloCommandsControlData) {
    ...
    const keyStyleNames = "bg-black/10 p-[5%] w-full rounded-[var(--radius)] border-[0.2rem] border-black/10 flex justify-center items-center select-none hover:bg-black/20 hover:scale-110 hover:cursor-pointer data-[active=true]:bg-green-600/20 data-[active=true]:scale-110 transition-all duration-100";
    ...
    return (
        <div style={{ display: "grid", gap: "1rem", width: "100%", height: "100%" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "1rem" }}>
                <div data-active={activeCommand} className={keyStyleNames} style={{ width: '100%' }}>
                ...
                <div data-active={activeEmergency} className={keyStyleNames} style={{ width: '100%' }}>
                ...
                <div data-active={activeTakeoff} className={keyStyleNames} style={{ width: '100%' }}>
                ...
                <div data-active={activeLand} className={keyStyleNames} style={{ width: '100%' }}>
                ...
                <div data-active={activeStreamOn} className={keyStyleNames} style={{ width: '100%' }}>
                ...
                <div data-active={activeStreamOff} className={keyStyleNames} style={{ width: '100%' }}>
