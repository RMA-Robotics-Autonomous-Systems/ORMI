...
import { addMapTypeArray, addTopicTypeFilter,  mapMarkerComponent } from "./teodor-emi-export";
...
class TeodorEMIPlugin extends Plugin{
    ...
    constructor(){
        ...
        this.addFilter("std-widgets-map-topic-available-type", mapTopicTypeFilter);
